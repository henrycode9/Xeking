...
export const ChessBoard2D: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-[min(94vw,calc(100dvh-280px))] lg:max-w-[calc(100dvh-135px)] aspect-square mx-auto flex items-center justify-center relative select-none shrink-0">
